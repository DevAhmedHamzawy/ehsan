        ...
        <div class="col-md-12">
            <div class="card">
                <h3 class="card-header">
                    مشاركين المسابقة {{ $contributors[0]->competition->name }}
                </h3>
...
$(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('contributors.index', Request::segment(2)) }}",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'user.name', name: 'user.name'},
            {data: 'user.city.arabic', name: 'user.city.arabic'},
            {data: 'user.country.arabic', name: 'user.country.arabic'},
