...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h1 class="text-center">التعديل على بيانات المدير</h1></div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <select name="role" id="role" class="form-control">
                                    ...
                                    <option value="0" selected disabled>مدير</option>
                                    <option value="2" selected disabled>محرر أسئلة</option>
